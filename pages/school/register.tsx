  ...
  return (
    <div className='h-screen'>
      <div className='md:flex justify-center'>
        ...
        <div className='w-full pt-[3em] pb-[7em]'>
          <div className='lg:max-w-[55em] md:max-w-[45em] md:mx-auto md:px-auto lg:px-[5em] xl:px-[7em] px-4'>
            ...
            <form className='flex flex-col'>
              ...
              <input type="text" placeholder='Role at school'  className='px-4 py-4 mb-5 text-[14px] input_border w-full shadow appearance-none leading-tight'/>
              <input type="text" placeholder='School Address'  className='px-4 py-4 mb-5 text-[14px] input_border w-full shadow appearance-none leading-tight'/>
