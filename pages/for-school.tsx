      ...
      <div className="ForSchool mt-[75px] md:px-20 xl:px-0 px-5" >
        <div className='container'>
          <div className='mobile:text-center py-[5em] md:py-15 pb-[5em] mobile:mt-0'>
            <h1 className='mobile:text-[28px] text-[40px] md:text-white md:text-[60px] xl:text-[85px] font-bold lg:leading-[75px] xl:leading-[120px]'>Get Yourself <br className='mobile:hidden md:hidden lg:block'/> Prepared For <br className='mobile:hidden md:hidden lg:block'/> CBT Exams</h1>
