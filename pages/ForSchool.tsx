    ...
    <Fragment>
      ...
      <div className="ForSchool mt-[75px] mobile:ForSchool " >
        <div className='space-y-6 mobile:text-center py-[5em] px-5 md:px-20 md:py-15 md:w-9/12 lg:w-7/12 pb-[5em]'>
          <h1 className='text-[40px] md:text-white md:text-[60px] font-bold leading-[75px]'>Get Yourself Prepared For CBT Exams</h1>
      ...
      <section className='md:pt-[6em] mobile:pt-[1em] md:px-20 text-center'>
