    ...
    <div className='GetStarted'>
      <div className='flex flex-col pt-[1em] pb-[5em] md:px-20 px-4 container'>
        ...
        <div className='mt-7 text-center mb-[4em]'>
          <h1 className='text-[55px] mobile:text-[35px] font-bold'>Get Started</h1>
          <p className='text-[24px] mobile:text-[20px]'>What do you want to use flip for?</p>
        </div>
        ...
        <div className='grid grid-cols-3 mobile:grid-cols-1 mobile:gap-y-5 gap-x-5 mx-auto'>
          <div className='flex flex-col items-center bg-white py-8 px-[3em] rounded-[30px] hover:border-2 hover:border-[#0075FF] shadow-[0px_4px_50px_rgba(0,0,0,0.1)]'>
            ...
            <h2 className='text-[36px] mobile:text-[25px] font-bold mt-5'>School</h2>
          ...
          <div className='flex flex-col items-center bg-white py-8 px-[3em] rounded-[30px] hover:border-2 hover:border-[#0075FF] shadow-[0px_4px_50px_rgba(0,0,0,0.1)]'>
            ...
            <h2 className='text-[36px] mobile:text-[25px] font-bold mt-5'>Organisation</h2>
            <p className='text-[20px] md:text-[18px] text-center mobile:text-[18px] mt-3'>I want Flip for my school</p>
          </div>
          <div className='flex flex-col items-center bg-white py-8 px-[3em] rounded-[30px] hover:border-2 hover:border-[#0075FF] shadow-[0px_4px_50px_rgba(0,0,0,0.1)]'>
            <Image src='/market.png' alt='Flip Cbt Logo' width='120px' height='120px' />
            <h2 className='text-[36px] mobile:text-[25px] font-bold mt-5'>Marketers</h2>
        ...
        <div className='mt-[7em] mobile:mt-[4em] mobile:text-center lg:ml-[3em]'>
          <div>
            <Link href="/Register">
              <a className='py-3 text-base text-white bg-[#0075FF] btn-border px-[12em] mobile:px-[6em] md:py-5'>Register</a>
            </Link>
          </div>
          <div className='mt-8 w-[28em] text-center mobile:w-full'>
