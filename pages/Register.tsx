  ...
  return (
    <div className='h-screen container'>
      <div className='md:flex'>
        ...
        <div className='md:w-1/2 block md:px-[4em] lg:px-[7em] pt-[3em] pb-[7em] px-4'>
          ...
          <p className='text-[16px] mb-8 mobile:text-center'>School Information</p> 

          <form className='flex flex-col'>
            <input type="text" placeholder='Name' className='px-4 py-4 mb-5 text-[14px] border w-full shadow appearance-none leading-tight rounded-[10px]'/>
            ...
            <input type="text" placeholder='Role at school'  className='px-4 py-4 mb-5 text-[14px] border w-full shadow appearance-none leading-tight rounded-[10px]'/>
            <input type="text" placeholder='School Address'  className='px-4 py-4 mb-5 text-[14px] border w-full shadow appearance-none leading-tight rounded-[10px]'/>
            ...
            <div className='mt-4'>
              <Link href="/">
                <a className='py-3 text-base text-white bg-[#0075FF] btn-border mobile:px-[142px] md:px-[155px] lg:px-[195px] md:py-4'>SUBMIT</a>
              </Link>
            </div>
          </form>
        </div>
