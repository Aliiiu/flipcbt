...
const Marketing = () => {
  return (
    <section className="md:px-20 mobile:px-4 py-[6em] bg-[url('/FlipCbtBg2.png')] bg-contain bg-[#0075FF] bg-opacity-90">
      <div className='container flex flex-col justify-center items-center space-y-7 text-center'>
        <h2 className='font-semibold text-[40px] mb-4 mobile:text-[28px] text-white'>Want to do martketing with Flip?</h2>
