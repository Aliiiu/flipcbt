    ...
    <Fragment>
      <section className='container px-5 md:px-20 xl:px-0 pt-[6em]'>
            ...
            <div className='relative flex justify-center mb-[4em]'>
                  <h1 className='inline-block md:text-[40px] text-[32px] text-center font-semibold mobile:pt-9'>Guaranteed benefits <br /> to your business</h1>
            ...
            >
                <div className={`w-6/12 mobile:w-full mobile:text-center md:pt-[4em] `}>
                        ...
                        <h1 className="font-semibold lg:pt-[6em] md:pt-[3em] text-[18px] md:text-[20px]">{item.heading}</h1>
