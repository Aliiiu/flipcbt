									...
									<div className='relative flex-1 h-full lg:h-[364px] text-center overflow-hidden rounded-3xl'>
										...
										<div className='py-20 absolute bg-[#06042c87] hover:backdrop-blur-lg w-full h-full'>
											...
											<Button
												...
												hover='hover:text-white hover:bg-primary bg-transparent hover:border-none transition-colors ease-in-out duration-500'
											/>
										</div>
									</div>
									<div className='relative flex-1 h-full lg:h-[364px] text-center rounded-3xl overflow-hidden'>
										...
										<div className='py-20 absolute bg-[#06042c87] hover:backdrop-blur-lg w-full h-full'>
											...
											<Button
												...
												content='Learn More'
												bgColor={'btn-border'}
												hover='hover:text-white hover:bg-primary bg-transparent hover:border-0 transition-colors ease-in-out duration-500'
											/>
										</div>
									</div>
								</div>
