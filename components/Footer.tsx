...
const Footer = () => {
  return (
    <footer className=' bg-[#06042C] md:px-20 md:pt-20 mobile:px-5'>
      <div className='flex mobile:flex-col container'>
        ...
        <div className='flex md:justify-between w-full md:mr-[6rem] mobile:flex-wrap'>
          <div className='space-y-8 mobile:mb-8 mobile:mx-[3rem]'>
            ...
            <h2 className='font-thin text-gray-500'><a href="#" className='hover:text-white'>Our Blog</a></h2>
            <h2 className='font-thin text-gray-500'><a href="#" className='hover:text-white'>Career</a></h2>
          </div>
          <div className='space-y-8'>
            <h2 className='text-white'>Resources</h2>
            <h2 className='font-thin text-gray-500'><a href="#" className='hover:text-white'>Terms of use</a></h2>
            <h2 className='font-thin text-gray-500'><a href="#" className='hover:text-white'>Privacy Policy</a></h2>
          </div>
          <div className='mb-[5rem] space-y-8 mobile:ml-[3rem]'>
            <h2 className='text-white'>Contact</h2>
            <p className="font-thin text-gray-500" ><a href="mailto:career@intrapair.com" className='hover:text-white'>career@intrapair</a></p>
