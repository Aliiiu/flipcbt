    ...
    <section className='flex md:px-20 pt-[2rem] bg-[#F7F8FA80] mobile:w-auto mobile:px-5'>
      <div className='mx-auto mobile:mx-0'>
        ...
        <div className='grid grid-cols-3 mobile:grid-cols-1 gap-x-8 md:mb-[10rem] mobile:space-y-6 mobile:mb-8'>
          <div className='flex flex-col items-center shadow-xl text-center lg:px-5 py-[4rem] bg-white rounded-2xl'>
            ...
            <h2 className='font-bold lg:text-[32px] text-[28px] md:mb-[3em] lg:mb-10'>Add Questions</h2>
          ...
          <div className='flex flex-col items-center shadow-xl text-center lg:px-5 py-[4rem] bg-white rounded-2xl'>
            ...
            <h2 className='font-bold lg:text-[32px] text-[28px]'>Participant Engage <br className='mobile:hidden'/> using any device</h2>
            <Image src='/engagement.png' alt='Time management illustration' width='300px' height='300px'/>
          </div>
          <div className='flex flex-col items-center shadow-xl text-center px-5 py-[4rem] bg-white rounded-2xl'>
            ...
            <h2 className='font-bold lg:text-[32px] text-[28px] md:mb-[2em] lg:mb-16'>Get Instant Result</h2>
