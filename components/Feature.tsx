    ...
    <section className='flex md:px-20 md:pt-[2rem] bg-[#F7F8FA80] mobile:w-auto mobile:px-5'>
      <div className='flex flex-col w-full mobile:mx-0'>
        <div className='text-center'>
          <h2 className='font-bold uppercase text-5xl mb-[2rem]'>Why Flip</h2>
          <h3 className='text-xl mb-[4rem]'>Lorem ipsum dolor sit amet,
            consectetur adipiscing elit. Est sit donec sed vestibulum, rhoncus.</h3>
        </div>
