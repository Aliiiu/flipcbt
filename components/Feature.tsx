    ...
    <section className='flex md:px-20 md:pt-[6rem] bg-[#F7F8FA80] mobile:w-auto mobile:px-5 mobile:bg-[#F7F8FA] mobile:pt-[4rem]'>
      <div className='flex flex-col w-full mobile:mx-0'>
        <div className='text-center'>
          <h2 className='font-bold uppercase text-5xl mb-[2rem] mobile:text-[32px]'>Why Flip</h2>
          <h3 className='text-xl mb-[4rem] mobile:text-[14px]'>Lorem ipsum dolor sit amet, consectetur
